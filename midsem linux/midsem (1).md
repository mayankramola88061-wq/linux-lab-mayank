...
### Name: mayank chand ramola , Roll No.: 590028605 Date: 2025-11-9
...
if [ -f "$LOG_FILE" ]; then
    mail -s "Daily System Log - $(date +%Y-%m-%d)" mayankramola88061@gmail.com < "$LOG_FILE"
    echo "Log emailed to local mailbox: mayankramola88061@gmail.com"
else
